  ...
  "node_modules/sql.js/dist/sql-wasm-browser.js"(exports, module) {
    ...
    var initSqlJs = function(moduleConfig) {
      ...
      initSqlJsPromise = new Promise(function(resolveModule, reject) {
        ...
        var wa = "./this.program", xa = (_b = (_a = globalThis.document) == null ? void 0 : _a.currentScript) == null ? void 0 : _b.src;
        ...
        var sb = { open(a) {
          ...
          var _a2;
          0 < ((_a2 = a.output) == null ? void 0 : _a2.length) && (Ba(db(a.output)), a.output = []);
        }, Dc() {
        ...
        var kc = void 0, Cc = () => {
          ...
          var _a2;
          Ea = a;
          Va || 0 < Ec || ((_a2 = k.onExit) == null ? void 0 : _a2.call(k, a), Da = true);
          throw new Pa(a);
        }, Kc = (a) => {
          if (!Da) try {
            a();
          ...
          var _a2;
          if (!Mc) {
            var a = { USER: "web_user", LOGNAME: "web_user", PATH: "/", PWD: "/", HOME: "/home/web_user", LANG: (((_a2 = globalThis.navigator) == null ? void 0 : _a2.language) ?? "C").replace("-", "_") + ".UTF-8", _: wa || "./this.program" }, b;
        ...
        (async function() {
          ...
          La ?? (La = k.locateFile ? k.locateFile("sql-wasm-browser.wasm", ya) : ya + "sql-wasm-browser.wasm");
